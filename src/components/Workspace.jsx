...
export default class Workspace extends React.Component {
  ...
  componentDidMount() {
    ...
    socket.emit("newPlan"); // tell the backend to make a new plan once this component is mounted
    // TODO: there should be an intro screen where you choose between making a new plan and uploading an existing one
  }
  savePlan() {
    let socket = this.context;
